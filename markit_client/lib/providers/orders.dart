...
class OrderItem {
  ...
  OrderItem({this.id, this.amount, this.products, this.dateTime, this.user});
}
...
class Orders with ChangeNotifier {
  ...
  Future<void> fetchAndSetOrders() async {
    final url =
        "https://rent-app-52a40.firebaseio.com/orders.json?auth=$authToken";
    ...
    //   return;
    // }
    // extractedData.forEach((newuser, orderData) {
    //   _loadedOrders.add(
    //     OrderItem(
    //       id: orderId,
